...
#   - mitmdump corriendo en $PROXY_HOST:$PROXY_PORT (run-mitm.sh).
#     Por defecto 127.0.0.1:8080 — para AVD seteá PROXY_HOST a la IP LAN
#     del host (la que el guest puede alcanzar), p.ej.:
#       PROXY_HOST=192.168.x.y ./run-avd.sh
set -euo pipefail
