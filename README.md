...
### Manual
Copiá `custom_components/ute_uruguay/` a `<config>/custom_components/ute_uruguay/` y reiniciá HA.

## Estructura del repo

```
ute-ha-uruguay/
├── custom_components/ute_uruguay/       # custom component HA (HACS-compliant en raíz)
